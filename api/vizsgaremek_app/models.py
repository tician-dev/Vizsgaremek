...
class ObjectiveMetric(models.Model):
    """
    Objektív (nem vélemény alapú) mutató egy adott Evaluation-höz kapcsolva.
    Pl. "Bukási arány", "Jegyátlag", stb.
    """
    ...
    label = models.CharField(
        max_length=100,
        help_text="Rövid cím, pl. 'Bukási arány', 'Jegyátlag'.",
    )
    value = models.CharField(
        max_length=100,
        help_text="Érték szövegesen, pl. '15%', '3.4', '10 fő / 30 fő'.",
    )
